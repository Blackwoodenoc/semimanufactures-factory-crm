export const C = {
  bg:"#1A1510", surface:"#231E17", surface2:"#2E271E", border:"#3D3428",
  text:"#F0E8DD", muted:"#A89882", dim:"#6B5D4D",
...
export const CC = ["#C8963E","#5A9E5F","#5B8DB5","#C44E3D","#8B6FAE","#B86B8A","#4E9E9A","#D4823A"];
